...
#' Instituto Nacional de Estadísticas de Chile. Contains 11 aggregated time-use activity
...
#'
#' The 11 time-use categories are aggregations of the 25 detailed categories in
#' \code{enut_ii_25G}. See \code{new_variables_postfilter()} in
