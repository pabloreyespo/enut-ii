#' enut-ii-25G-ENG
#'
#' English-renamed version of \code{enut_ii_25G}. All variable names are translated
#' to English; values and units are unchanged. See \code{enut_ii_25G} for full
...
#'
#'   \item{t_paid_work}{Trabajo remunerado (paid work), weekly hours}
#'   \item{t_care_essential}{Essential caregiving: physical personal care of household members, weekly hours}
#'   \item{t_care_education_related}{Education-related caregiving: school accompaniment, homework help, weekly hours}
#'   \item{t_care_other}{Other caregiving: medical accompaniment, transport, other care, weekly hours}
#'   \item{t_domestic_meals}{Meal preparation and food service, weekly hours}
#'   \item{t_domestic_cleaning}{Household cleaning, weekly hours}
#'   \item{t_domestic_laundry}{Laundry and clothing care, weekly hours}
#'   \item{t_domestic_maintenance}{Household maintenance and minor repairs, weekly hours}
#'   \item{t_domestic_admin}{Household administration (bills, paperwork, errands), weekly hours}
#'   \item{t_domestic_shopping}{Household shopping, weekly hours}
#'   \item{t_domestic_pets}{Care of pets and plants, weekly hours}
#'   \item{t_voluntary_community}{Voluntary community work, weekly hours}
#'   \item{t_voluntary_households}{Voluntary help to other households, weekly hours}
#'   \item{t_personal_care}{Personal care excluding sleep and meals (hygiene, medical, exercise), weekly hours}
...
#'   \item{t_leisure_social}{Social activities and recreation (socializing, parties, sports as spectator), weekly hours}
#'   \item{t_leisure_hobbies}{Arts and hobbies (creative arts, crafts, games), weekly hours}
#'   \item{t_media_reading}{Reading (books, press, digital), weekly hours}
#'   \item{t_media_audio}{Audio media consumption (radio, music, podcasts), weekly hours}
#'   \item{t_media_video}{Video and television consumption, weekly hours}
#'   \item{t_media_computer}{Leisure computer and internet use, weekly hours}
...
#' }
#'
#' @seealso \code{enut_ii_25G} for Spanish variable names and full methodological details.
#'
...
#' @docType data
#' @keywords datasets
#' @name enut_ii_25G_ENG
#' @usage data(enut_ii_25G_ENG)
